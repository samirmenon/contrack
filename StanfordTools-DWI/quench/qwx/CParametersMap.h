// Author: dakers
//
// A class used to represent a set of parameters associated with a network communication command. e.g., for pushing an ROI to Quench, the parameters include the mask image, and an offset to position that image.
