...
#include "Wm4/Wm4BSplineFitBasis.h"
...
public:
  ...
  BSplineCurveFit (int iDimension, int iSampleQuantity, const Real* afSampleData, int iDegree, int iControlQuantity);
  BSplineCurveFit (int iDimension, int iDegree, int iControlQuantity, const Real* fCtrlData);
  ~BSplineCurveFit ();
