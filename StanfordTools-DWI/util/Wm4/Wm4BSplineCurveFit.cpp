    ...
    m_kBasis(iControlQuantity,iDegree)
{
    ...
    m_afControlData = new Real[m_iDimension*iControlQuantity];
    ...
    BandedMatrixd* pkATAMat = new BandedMatrixd(m_iControlQuantity,
...
//----------------------------------------------------------------------------
template <class Real>
BSplineCurveFit<Real>::BSplineCurveFit (int iDimension, int iDegree, int iControlQuantity, const Real* fCtrlData)
    :
    m_kBasis(iControlQuantity,iDegree)
{
    assert(iDimension >= 1);
    ...
    m_iControlQuantity = iControlQuantity;
    m_afControlData = new Real[m_iDimension*iControlQuantity];
    memcpy(m_afControlData,fCtrlData,m_iControlQuantity*m_iDimension*sizeof(Real));
}
//----------------------------------------------------------------------------
